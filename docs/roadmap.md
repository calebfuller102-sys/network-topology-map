...
| SSE event bus and recovery | Phase 5 | Deferred; HTTP snapshots use an explicit read transaction, but no event revision/cursor exists yet | Revision-safe initial sync, reconnect snapshot recovery, and proxy keepalive test pass |
