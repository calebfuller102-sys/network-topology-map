...
| Auth | Owner supplies authentication at NPM; application also binds its gateway to loopback by default and documents how to prevent bypassing NPM. NPM protection must cover both UI and `/api`, including SSE. |
